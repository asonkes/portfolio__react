...
export const AnimationText = () => {
  ...
  return (
    <div className="absolute w-full h-fit right-[50%] flex flex-col bottom-40 translate-[50%] text-5xl text-center tracking-wider sm:text-6xl sm:bottom-37 lg:w-auto lg:flex-row lg:bottom-20">
