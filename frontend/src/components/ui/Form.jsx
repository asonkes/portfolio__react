...
export const Form = () => {
  return (
    <form className="w-full flex justify-center">
        ...
        <button className="w-37 mx-auto my-10 text-white text-xl border-2 border-white rounded-2xl p-2 cursor-pointer hover:text-fuchsia-300 hover:scale-105">Envoyer</button>
